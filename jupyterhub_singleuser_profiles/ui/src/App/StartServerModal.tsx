...
import { CM_PATH, DEV_MODE } from '../utils/const';
...
const StartServerModal: React.FC<StartServerModalProps> = ({ shown, onClose }) => {
        ...
        >
          <AccordionItem>
            <AccordionToggle
              ...
              id="messages-toggle"
              className="jsp-spawner__start-modal__accordion-toggle"
            >
