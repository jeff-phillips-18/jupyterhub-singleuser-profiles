...
const Admin: React.FC = () => {
  ...
  const runningCount = userResults.users.filter((u) => u.server !== null).length;

  return (
    <div className="jsp-app jsp-app__admin" ref={pageRef}>
      <div className="jsp-app__header">
        <div className="jsp-app__header__title-line">
          ...
          <div className="jsp-app__admin__buttons-bar">
            <Button
